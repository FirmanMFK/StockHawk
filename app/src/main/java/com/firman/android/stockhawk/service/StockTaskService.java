package com.firman.android.stockhawk.service;
...
import com.firman.android.stockhawk.stock_history.HistoryDataHandler;
import com.firman.android.stockhawk.stock_history.model.HistoryQuote;
import com.firman.android.stockhawk.stock_history.realm.RealmController;
import com.firman.android.stockhawk.stock_history.realm.StockData;
...
public class StockTaskService extends GcmTaskService{
    ...
    if (urlStringBuilder != null){
      ...
      try{
        ...
        try {
          ...
          // send broadcast to update widget data
  ...
  public void storeStockHistoryData(String stockSymbol){
    try {
      ...
      List<HistoryQuote> rawQuotes = new HistoryDataHandler().getStockQuotes(url);
